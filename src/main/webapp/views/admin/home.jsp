									...
									<div class="ace-settings-item">
										<div class="pull-left">
											...
											<div class="dropdown dropdown-colorpicker"> <a data-toggle="dropdown"
													class="dropdown-toggle" href="#"><span class="btn-colorpicker"
														style="background-color:#438EB9"></span></a>
												<ul class="dropdown-menu dropdown-caret">
													<li><a class="colorpick-btn selected" href="#"
															style="background-color:#438EB9;" data-color="#438EB9"></a>
													</li>
													<li><a class="colorpick-btn" href="#"
															style="background-color:#222A2D;" data-color="#222A2D"></a>
													</li>
													<li><a class="colorpick-btn" href="#"
															style="background-color:#C6487E;" data-color="#C6487E"></a>
													</li>
													<li><a class="colorpick-btn" href="#"
															style="background-color:#D0D0D0;" data-color="#D0D0D0"></a>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="infobox infobox-orange2">
											<div class="infobox-chart">
												<span class="sparkline"
													data-values="196,128,202,177,154,94,100,170,224"><canvas width="44"
														height="26"
														style="display: inline-block; width: 44px; height: 26px; vertical-align: top;"></canvas></span>
											</div>
										...
										<div class="infobox infobox-blue infobox-small infobox-dark">
											<div class="infobox-chart">
												<span class="sparkline" data-values="3,4,2,3,4,4,2,2"><canvas width="39"
														height="15"
														style="display: inline-block; width: 39px; height: 15px; vertical-align: top;"></canvas></span>
											</div>
											...
											<div class="widget-body">
												<div class="widget-main">
													<div id="piechart-placeholder"
														...
														<canvas class="flot-base" width="367" height="150"
															style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 367px; height: 150px;"></canvas><canvas
															class="flot-overlay" width="367" height="150"
															style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 367px; height: 150px;"></canvas>
														<div class="legend">
															<div
																style="position: absolute; width: 90px; height: 110px; top: 15px; right: -30px; background-color: rgb(255, 255, 255); opacity: 0.85;">
															</div>
															<table
																	...
																	<tr>
																		<td class="legendColorBox">
																			<div
																				...
																				<div
																					style="width:4px;height:0;border:5px solid #68BC31;overflow:hidden">
																				</div>
																			</div>
																		</td>
																	...
																	<tr>
																		<td class="legendColorBox">
																			<div
																				style="border:1px solid null;padding:1px">
																				<div
																					style="width:4px;height:0;border:5px solid #2091CF;overflow:hidden">
																				</div>
																			</div>
																		</td>
																	...
																	<tr>
																		<td class="legendColorBox">
																			<div
																				style="border:1px solid null;padding:1px">
																				<div
																					style="width:4px;height:0;border:5px solid #AF4E96;overflow:hidden">
																				</div>
																			</div>
																		</td>
																	...
																	<tr>
																		<td class="legendColorBox">
																			<div
																				style="border:1px solid null;padding:1px">
																				<div
																					style="width:4px;height:0;border:5px solid #DA5430;overflow:hidden">
																				</div>
																			</div>
																		</td>
																	...
																	<tr>
																		<td class="legendColorBox">
																			<div
																				style="border:1px solid null;padding:1px">
																				<div
																					style="width:4px;height:0;border:5px solid #FEE074;overflow:hidden">
																				</div>
																			</div>
																		</td>
													...
													<table class="table table-bordered table-striped">
														...
														<tbody>
															...
															<tr>
																...
																<td class="hidden-480">
																	<span
																		class="label label-danger arrowed">pending</span>
																</td>
															</tr>
											...
											<div class="widget-body">
												<div class="widget-main padding-4">
													<div id="sales-charts"
														...
														<canvas class="flot-base" width="608" height="220"
															style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 608px; height: 220px;"></canvas>
														<div class="flot-text"
															...
															<div class="flot-x-axis flot-x1-axis xAxis x1Axis"
																...
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 27px; text-align: center;">
																	0.0</div>
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 118px; text-align: center;">
																	1.0</div>
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 210px; text-align: center;">
																	2.0</div>
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 301px; text-align: center;">
																	3.0</div>
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 392px; text-align: center;">
																	4.0</div>
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 483px; text-align: center;">
																	5.0</div>
																<div class="flot-tick-label tickLabel"
																	style="position: absolute; max-width: 68px; top: 203px; left: 575px; text-align: center;">
																	6.0</div>
															</div>
														...
														</div><canvas class="flot-overlay" width="608" height="220"
															style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 608px; height: 220px;"></canvas>
														<div class="legend">
															<div
																style="position: absolute; width: 62px; height: 66px; top: 13px; right: 13px; background-color: rgb(255, 255, 255); opacity: 0.85;">
															</div>
															<table
												...
												<div class="widget-main padding-4">
													<div class="tab-content padding-8">
														...
														<div id="comment-tab" class="tab-pane">
																...
																<div class="scroll-content" style="max-height: 300px;">
																	<div class="itemdiv commentdiv">
																		...
																		<div class="body">
																			...
																			<div class="text">
																				<i
																					class="ace-icon fa fa-quote-left"></i>
																				Lorem ipsum dolor sit amet, consectetur
																				adipiscing elit. Quisque commodo massa
															...
															<div class="center">
																<i
																	class="ace-icon fa fa-comments-o fa-2x green middle"></i>
												...
												<div class="widget-main no-padding">
													<div class="dialogs ace-scroll">
														<div class="scroll-track scroll-active"
															...
															<div class="scroll-bar" style="height: 236px; top: 0px;">
															</div>
														</div>
														<div class="scroll-content" style="max-height: 300px;">
															<div class="itemdiv dialogdiv">
																...
																<div class="body">
																	...
																	<div class="text">Lorem ipsum dolor sit amet,
																		consectetur adipiscing elit. Quisque commodo
																		massa sed ipsum porttitor facilisis.</div>
